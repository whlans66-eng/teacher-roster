...
- **使用對象**：修課學生
- **主要目的**：查看課程資訊、填寫教學問卷
- **登入需求**：Azure AD SSO（公司 Outlook 帳號）
- **角色分配**：根據部門自動分配（部門包含「學員」或「學生」關鍵字）

### 1.3 教師 (Teacher)
- **使用對象**：專任、兼任、外聘教師
- **主要目的**：管理個人資料、查看授課資訊
- **登入需求**：
  - 內部教師：Azure AD SSO（公司 Outlook 帳號）
  - 外聘教師：Azure AD 訪客帳號或手動建立帳號
- **角色分配**：根據部門自動分配（部門包含「教師」或「講師」關鍵字）

### 1.4 管理者 (Admin)
- **使用對象**：系統管理員、課務組人員
- **主要目的**：完整系統管理
- **登入需求**：Azure AD SSO（公司 Outlook 帳號）
- **角色分配**：根據部門自動分配（部門包含「課務組」、「教務處」或「系統管理」關鍵字）
